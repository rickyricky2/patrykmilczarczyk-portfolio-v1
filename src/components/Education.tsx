...
export default function Experience() {
    ...
    return (
        <section id={"education"} ref={ref} className={"w-full pt-20"}>
            ...
            <div className={"my-10 lg:w-[80%] tracking-tight flex flex-col gap-10 sm:gap-5"}>
                {Object.entries(t("education.main",{returnObjects:true})).map(([key, value]) => (
                    <section
                        key={key}
                        className={"flex justify-between flex-col-reverse sm:flex-row max-sm:gap-2 max-sm:items-center py-5 sm:py-10 hover:bg-black/10 hover:shadow-sm dark:hover:bg-white/6 px-5 -mx-5 backdrop-blur-lg rounded-md transition-all"}>
